...
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------- | ------------------------- |
| [Standalone](https://linkdlab.github.io/FuncNodes/v1.7.0/experimental/standalone/index.md) | Open a single `.fnw` workflow with its own dedicated worker | Stable for day-to-day use |
...
→ See [Standalone](https://linkdlab.github.io/FuncNodes/v1.7.0/experimental/standalone/index.md) for full documentation.
