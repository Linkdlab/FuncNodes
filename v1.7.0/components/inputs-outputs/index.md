...
- **set_default**: If the value of the IO is set manually, this flag indicates whether the new value should be set as the default value for the IO (meaning it will also be serialized, and has to be [serializable](https://linkdlab.github.io/FuncNodes/v1.7.0/components/serialization/index.md)).
