...
See [Event System](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/event-system/index.md) for the complete event reference.
...
- [Architecture Overview](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/overview/index.md) — System-level view
- [Worker Components](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/worker-components/index.md) — Worker runtime
- [Event System](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/event-system/index.md) — Event reference
- [Creating Nodes](https://linkdlab.github.io/FuncNodes/v1.7.0/components/node/index.md) — User guide
