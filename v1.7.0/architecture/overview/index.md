...
See [Message Protocol](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/message-protocol/index.md) for the complete reference.
...
- [Core Components](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/core-components/index.md) — `funcnodes_core` internals
- [Worker Components](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/worker-components/index.md) — `funcnodes_worker` internals
- [Message Protocol](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/message-protocol/index.md) — RPC command reference
- [Event System](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/event-system/index.md) — Event types and handling
