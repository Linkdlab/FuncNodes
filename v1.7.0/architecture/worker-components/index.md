...
- [Message Protocol](https://linkdlab.github.io/FuncNodes/v1.7.0/architecture/message-protocol/index.md) — RPC reference
- [Worker Configuration](https://linkdlab.github.io/FuncNodes/v1.7.0/components/worker_config/index.md) — User guide
