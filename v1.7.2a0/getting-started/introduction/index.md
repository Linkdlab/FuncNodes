...
1. **[Install FuncNodes](https://linkdlab.github.io/FuncNodes/v1.7.2a0/getting-started/installation/index.md)** — Set up your environment
1. **[First Steps](https://linkdlab.github.io/FuncNodes/v1.7.2a0/getting-started/basic_usage/index.md)** — Launch the UI and create your first workflow
1. **[Creating Nodes](https://linkdlab.github.io/FuncNodes/v1.7.2a0/components/node/index.md)** — Learn the two ways to define nodes
1. **[Inputs & Outputs](https://linkdlab.github.io/FuncNodes/v1.7.2a0/components/inputs-outputs/index.md)** — Understand data flow and type hints
