...
- [Architecture Overview](https://linkdlab.github.io/FuncNodes/architecture/overview/index.md) — System-level view
- [Core Components](https://linkdlab.github.io/FuncNodes/architecture/core-components/index.md) — `funcnodes_core` internals
- [Message Protocol](https://linkdlab.github.io/FuncNodes/architecture/message-protocol/index.md) — RPC reference
- [Worker Configuration](https://linkdlab.github.io/FuncNodes/components/worker_config/index.md) — User guide
