...
- [Core Components](https://linkdlab.github.io/FuncNodes/architecture/core-components/index.md) — `funcnodes_core` internals
- [Worker Components](https://linkdlab.github.io/FuncNodes/architecture/worker-components/index.md) — `funcnodes_worker` internals
- [Message Protocol](https://linkdlab.github.io/FuncNodes/architecture/message-protocol/index.md) — RPC command reference
- [Event System](https://linkdlab.github.io/FuncNodes/architecture/event-system/index.md) — Event types and handling
