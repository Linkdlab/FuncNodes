...
See [Message Protocol](https://linkdlab.github.io/FuncNodes/dev/architecture/message-protocol/index.md) for the complete reference.
...
- [Core Components](https://linkdlab.github.io/FuncNodes/dev/architecture/core-components/index.md) — `funcnodes_core` internals
- [Worker Components](https://linkdlab.github.io/FuncNodes/dev/architecture/worker-components/index.md) — `funcnodes_worker` internals
- [Message Protocol](https://linkdlab.github.io/FuncNodes/dev/architecture/message-protocol/index.md) — RPC command reference
- [Event System](https://linkdlab.github.io/FuncNodes/dev/architecture/event-system/index.md) — Event types and handling
