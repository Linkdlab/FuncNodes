...
- [Architecture Overview](https://linkdlab.github.io/FuncNodes/v1.6.0/architecture/overview/index.md) — System diagram
- [Core Components](https://linkdlab.github.io/FuncNodes/v1.6.0/architecture/core-components/index.md) — Event emitter implementation
- [Message Protocol](https://linkdlab.github.io/FuncNodes/v1.6.0/architecture/message-protocol/index.md) — WebSocket event relay
- [Inputs & Outputs](https://linkdlab.github.io/FuncNodes/v1.6.0/components/inputs-outputs/index.md) — IO events
