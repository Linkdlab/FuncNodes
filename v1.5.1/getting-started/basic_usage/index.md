...
1. For more options see the [CLI reference](https://linkdlab.github.io/FuncNodes/v1.5.1/api/cli/#runserver)
...
[Workers](https://linkdlab.github.io/FuncNodes/v1.5.1/components/worker/index.md) are isolated execution environments that run your workflows. Each worker has:
...
After installation, the module's [shelf](https://linkdlab.github.io/FuncNodes/v1.5.1/components/shelf/index.md) appears in the **Lib** menu.

______________________________________________________________________

## 5. Add Nodes to Your Workflow

[Nodes](https://linkdlab.github.io/FuncNodes/v1.5.1/components/node/index.md) are the computational units—functions with [inputs](https://linkdlab.github.io/FuncNodes/v1.5.1/components/inputs-outputs/index.md) and outputs.

### Adding Nodes

1. Open the **Lib** menu
1. Browse shelves or use the **search bar**
1. **Double-click** a node name to add it to the [nodespace](https://linkdlab.github.io/FuncNodes/v1.5.1/components/nodespace/index.md)
...
| Topic                                                                                              | Description                                   |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| [Creating Nodes](https://linkdlab.github.io/FuncNodes/v1.5.1/components/node/index.md)             | Build custom nodes with decorators or classes |
| [Inputs & Outputs](https://linkdlab.github.io/FuncNodes/v1.5.1/components/inputs-outputs/index.md) | Understand data flow and type rendering       |
| [Examples](https://linkdlab.github.io/FuncNodes/v1.5.1/examples/index.md)                          | See complete workflow examples                |
| [Available Modules](https://linkdlab.github.io/FuncNodes/v1.5.1/modules/index.md)                  | Browse the official module ecosystem          |
