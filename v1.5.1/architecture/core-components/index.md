...
See [Event System](https://linkdlab.github.io/FuncNodes/v1.5.1/architecture/event-system/index.md) for the complete event reference.
...
- [Worker Components](https://linkdlab.github.io/FuncNodes/v1.5.1/architecture/worker-components/index.md) — Worker runtime
- [Event System](https://linkdlab.github.io/FuncNodes/v1.5.1/architecture/event-system/index.md) — Event reference
- [Creating Nodes](https://linkdlab.github.io/FuncNodes/v1.5.1/components/node/index.md) — User guide
