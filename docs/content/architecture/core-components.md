...
2. Return type annotation → `NodeOutput` type
3. Return value → Assigned to output
4. Sync functions wrapped in async
...
See [Event System](event-system.md) for the complete event reference.
...
- [Worker Components](worker-components.md) — Worker runtime
- [Event System](event-system.md) — Event reference
- [Creating Nodes](../components/node.md) — User guide
