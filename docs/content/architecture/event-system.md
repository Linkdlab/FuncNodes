...
2. Result becomes `column.value_options["options"]`
3. `value_options_changed` event fires
4. UI updates dropdown
...
- [Core Components](core-components.md) — Event emitter implementation
- [Message Protocol](message-protocol.md) — WebSocket event relay
- [Inputs & Outputs](../components/inputs-outputs.md) — IO events
