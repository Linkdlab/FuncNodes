...
- [Node Outputs](nodeoutput.md) — Output connection points
- [Inputs & Outputs](inputs-outputs.md) — Complete IO reference
- [Creating Nodes](node.md) — Node creation patterns
