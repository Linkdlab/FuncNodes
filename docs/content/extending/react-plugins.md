...
2. **Console logging** — `console.log()` in your plugin
...
- [Testing Modules](testing-modules.md) — Testing your module
- [Inputs & Outputs](../components/inputs-outputs.md) — Render options reference
