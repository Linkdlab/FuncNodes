...
2. **Shelf organization** — Grouping nodes into a browsable hierarchy
3. **Entry points** — Registration so FuncNodes discovers your module
4. **Optional: React plugin** — Custom UI components for your nodes
...
2. **Prefix with module name**: `funcnodes_mymodule.category.node_name`
3. **Group by function**: Math, I/O, Transforms, etc.
4. **Limit depth**: 2-3 levels of subshelves maximum
5. **Add descriptions**: Help users understand each shelf's purpose
...
See [Testing Modules](testing-modules.md) for comprehensive testing guidance.

---

## React Plugin Development

For custom UI components (editors, previews, widgets), see [React Plugins](react-plugins.md).
...
- [React Plugins](react-plugins.md) — Custom UI components
- [Testing Modules](testing-modules.md) — Comprehensive testing guide
- [Creating Nodes](../components/node.md) — Node fundamentals
- [Shelves](../components/shelf.md) — Shelf organization
- [Available Modules](../modules/index.md) — Official module examples
