...
[Nodes](https://linkdlab.github.io/FuncNodes/components/node/index.md) are the computational units—functions with [inputs](https://linkdlab.github.io/FuncNodes/components/inputs-outputs/index.md) and outputs.
