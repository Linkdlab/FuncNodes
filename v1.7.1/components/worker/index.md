...
For stateful integrations that provide instance-bound nodes and background loops, see [External Workers](https://linkdlab.github.io/FuncNodes/v1.7.1/components/external-workers/index.md).
