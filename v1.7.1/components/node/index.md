...
How the Node input and Output can be further customized with decorators is described in the [Inputs and Outputs](https://linkdlab.github.io/FuncNodes/v1.7.1/components/inputs-outputs/index.md) section.
